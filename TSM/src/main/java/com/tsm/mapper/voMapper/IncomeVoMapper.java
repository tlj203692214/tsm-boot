...
public interface IncomeVoMapper extends BaseMapper<IncomeVo> {
    @Select("select * from PAYMONEY p \n" +
     ...
     IPage<IncomeVo> selectIncomeVo(Page page,Wrapper wrapper,@Param("stuName") String name);
    ...
    IPage<IncomeVo> selectIncomeVoByPayMode(Page page,Wrapper wrapper,@Param("name") String name,@Param("money") String money);
}
